...
import Fragments.UpdateTutorProfileFragment;


public class TutorProfileFragment extends Fragment {

    private ImageView profilePic;
    private TextView nameTV, emailTV, passwordTV,coursesTV;
    private Button updateProfilebtn;
    private DatabaseReference dbRef,dbCourseRef;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        updateProfilebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ft.replace(R.id.fragment_container,new UpdateTutorProfileFragment());
                ft.commit();
            }
        });
